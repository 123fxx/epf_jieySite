    ...
    <div class="area">
      ...
      <div class="new-step display">
        <div class="laba display align justify">
          <img src="@/assets/image/home/laba.png" alt />
        </div>
          ...
          <div class="push-top display align">
            ...
            >
              <div>
                ...
                <div class="logon-one-text">{{item.name}}</div>
              </div>
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      server: [
        {
          name: "服务指南",
          url: require("@/assets/image/home/server1.png"),
          id: "008",
          eng: "FWZN",
        },
        {
          name: "交易流程",
          url: require("@/assets/image/home/server2.png"),
          id: "016",
          eng: "JYLC",
        },
        {
          name: "业务咨询",
          url: require("@/assets/image/home/server3.png"),
          id: "000004",
        },
        {
          name: "投诉举报",
          url: require("@/assets/image/home/server4.png"),
          id: "000005",
        },
      ],
      logoDataTop: [
      ...
      logoDataBottom: [
        ...
        {
          name: "广东省政务服务网",
          url: require("@/assets/image/home/push8.png"),
        },
      ],
      loading1: false,
      i: 0,
  ...
  methods: {
    getLaba(id) {
      this.$get("/ords/epfcms/cmsItem/queryItemNewNotice", {}).then((res) => {
        let data = res.items;
        // let arr = []
        // let result = []
        // if (!data) {
    ...
    getData(id) {
      this.$get("/ords/epfcms/cmsItem/queryCmsItemDetails/" + id, {}).then(
        (res) => {
    ...
    getList(val) {
      ...
      this.i++;
      this.loading1 = true;
      this.$get("/ords/epfcms/cmsItem/queryCmsItemBySeriesId/" + val, {}).then(
        (res) => {
          switch (val) {
            case "001003":
    ...
    getBanner() {
      this.$get("/ords/epfcms/cmsItem/queryCmsItemFlash", {}).then((res) => {
    ...
    getTree(val) {
      ...
      this.$get("/ords/epfcms/series/queryListCmsSeriesAll", {}).then((res) => {
