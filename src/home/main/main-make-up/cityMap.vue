      ...
      <div class="phone">
        <el-scrollbar style="height:100%">
          <div class="phone-contain">
            <div class="phone-one" v-for="(item,index) in data" :key="index">
              <div class="title">{{item.name}}</div>
              <div class="content">
                <div v-for="(tel,telIndex) in item.children" :key="telIndex">
                  <span>{{tel.name}}：</span>
...
export default {
  data() {
    return {
      ...
      geoCoordMap: [
        {
          name: "揭阳市政务服务中心",
          value: [116.37905, 23.558611],
          address: "hahahahahahah",
        },
        {
          name: "惠来县公共资源交易中心",
          value: [116.302927, 23.03418],
          address: "惠来县公共资源交易中心",
        },
            ...
            },
            {
              ...
              data: [
                ...
                [
                  ...
                  23.034824,
                  {
                    name: "揭阳市公共资源交易中心惠来分中心",
                    address:
                      "惠来县惠城镇南门西路21号（中国工商银行惠来支行9楼）",
                  },
                ],
                ...
                [
                  ...
                  23.451658,
                  {
                    name: "揭阳市公共资源交易中心揭西分中心",
                    address: "揭西县政务服务中心B栋2楼",
                  },
                ],
                [
                  116.16635,
                  23.326754,
                  {
                    name: "揭阳市公共资源交易中心普宁分中心",
                    address: "普宁市燎原街道群飞大厦7、8楼",
                  },
                ],
                [
                  116.435667,
              ...
              tooltip: {
                ...
                extraCssText:
                  "box-shadow: 3px 4px 17px 1px rgba(183, 218, 254, 0.7);border-radius: 10px;",
              },
  ...
  mounted() {
    this.$nextTick(function () {
      let hostIPAndPort = window.location.origin;
      let pathName = window.location.pathname;
      setTimeout(() => {
        this.loadMapChart(
          hostIPAndPort + pathName + "static/445200.json",
          // '../../../../static/445200.json',
          "揭阳市"
        );
      }, 200);
