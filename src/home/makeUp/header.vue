    ...
    <div class="header">
      <div class="area area-contain">
        ...
        <div class="right display align">
          <a @click="SetHome" class="set">设为首页</a>
          /
          <span @click="collect" class="set">加入收藏</span>
        </div>
      </div>
    </div>
    ...
    <div class="nav">
      <div class="area display" style="justify-content:space-between">
        ...
        <div class="nav-search display align">
          ...
          <div class="nav-button display align justify" @click="jump">搜索</div>
        </div>
      </div>
    </div>
  </div>
    ...
    return {
      ...
      nav: [
        ...
        // { name: '资料下载', path: '/notice', query: { index: '3', id: '007002', name: '政府采购' }, },
        {
          name: "办事指南",
          path: "/server",
          query: { index: "3", id: "008", name: "操作指南", eng: "FWZN" },
        },
        {
          name: "咨询投诉",
          path: "/answer",
          query: { index: "4", id: "000004", name: "业务咨询" },
        },
