<template>
  <div class="answer">
    ...
    <el-dialog :visible.sync="dialogVisible" :show-close="false" width="35%">
      <template slot="title">
      ...
      <div class="form-contain">
        <el-form ref="ownerForm0" :model="form" label-width="100px" :rules="formrules">
          ...
          <el-form-item label="业务模块" prop="consultBusiness">
            <el-select v-model="form.consultBusiness" placeholder="请选择">
              <el-option
                v-for="item in business.children"
                :key="item.no"
                :label="item.name"
                :value="item.no"
              ></el-option>
    ...
    <el-dialog :visible.sync="dialogVisible2" :show-close="false" width="35%">
      <template slot="title">
        <div class="dialog-title display align">
